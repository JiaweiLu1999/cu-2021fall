...
def main(args):
    ...
    audio_clips_list = librosa.util.find_files(args.testset_dir, ext='wav')
    scores = []
    for fpath in tqdm(audio_clips_list[0:]):
...
if __name__=="__main__":
    ...
    parser.add_argument("--testset_dir", default='/Users/javeylew/Desktop/PDL/s_baseline_16k',
                        help='Path to the dir containing audio clips to be evaluated')
    parser.add_argument('--score_file', default = '/Users/javeylew/Desktop/PDL/result', help='If you want the scores in a CSV file provide the full path')
